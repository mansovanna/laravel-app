...
@section('content')
<<<<<<< HEAD
    <div class="w-full bg-link-100/50">
        <div class="bg-pink-200 rounded-lg shadow p-7 mx-auto" style="margin: 0px 300px;">
            <div class="flex justify-between items-center">
                <div class="space-y-2 left-10">
                    <h4 class="text-gray-700">Get up to 50% off Today only</h4>
                    <h1 class="text-3xl font-bold text-gray-900">iPhone 11 Pro Max</h1>
                    <div class="flex items-center space-x-2">
                        <span class="text-1xl font-bold text-blue-500">$450.00</span>
                        <span class="text-sm line-through text-gray-400">$550.45</span>
                    </div>
                    <a href="#" class="mt-4 inline-block bg-blue-500 text-white px-6 py-2 rounded-full">SHOP NOW</a>
                </div>

                <!-- Iphone 11 -->
                <div class="relative">
                    <img src="https://target.scene7.com/is/image/Target/GUEST_ed6c1df5-e85a-4cdc-a5ca-b3d14913e0f5?wid=488&hei=488&fmt=pjpeg" alt="iPhone 11" class="h-60 object-cover">
                </div>
            </div>
        </div>

        <!-- 3 -->
        <div class="mt-8 grid grid-cols-3 gap-32 px-20 p-8">
            <div class="border-2 border-blue-500 p-4 rounded-lg text-center">
                <div class="text-red-500 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v4h.293l.5 2H7m2 0h10a1 1 0 011 1v1h1a1 1 0 011 1v6a1 1 0 01-1 1h-1M7 14h7m-7 0H5v-4h2m0 4v1a1 1 0 001 1h1m7-1h1a1 1 0 001-1v-5H9m10 0V7a1 1 0 00-1-1H7m0 0H5l-1-2H3M3 7v10a1 1 0 001 1h13a1 1 0 001-1v-1M5 12v-2a1 1 0 011-1h3m4 0h5" />
                    </svg>
                </div>
                <h2 class="text-sm font-bold">Free Shipping</h2>
                <p class="text-xs text-gray-600">Orders over $200</p>
            </div>

            <div class="border-2 border-blue-500 p-4 rounded-lg text-center">
                <div class="text-red-500 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c.832 0 1.5-.668 1.5-1.5S12.832 5 12 5 10.5 5.668 10.5 6.5 11.168 8 12 8zm0 0v1a6 6 0 006 6v3H6v-3a6 6 0 006-6V8z" />
                    </svg>
                </div>
                <h2 class="text-sm font-bold">Money Returns</h2>
                <p class="text-xs text-gray-600">30 Days money return</p>
            </div>

            <div class="border-2 border-blue-500 p-4 rounded-lg text-center">
                <div class="text-red-500 mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h1a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm4 0a2 2 0 012-2h1a2 2 0 012 2v4m0 0h5m-5 0v5m5-5h1a2 2 0 012 2v4a2 2 0 01-2 2h-1a2 2 0 01-2-2v-1m0 0h-5" />
                    </svg>
                </div>
                <h2 class="text-sm font-bold">24/7 Support</h2>
            ...
            <div class="w-full    col-span-5 ">
                ...
                <div class="flex flex-row justify-between items-center">
                    ...
                    <button id="buttonSet"
                        ...
                        <svg id="reteteIcon" class="w-4 text-secondary  duration-300 ease-linear" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  fill="none">
                    ...
                    <div class="flex flex-row justify-end items-center gap-3">
                        {{-- Icon App --}}
                        <a href="#" class="text-white py-2 px-3 rounded-sm bg-danger border border-danger">
                            <svg class="w-4 text-white font-medium" xmlns="http://www.w3.org/2000/svg"
                        ...
                        {{-- Icon --}}
                        <a href="#" class=" py-2 px-3 rounded-sm border text-danger border-danger">
                            <svg class="w-4 text-sceondary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="none">
                ...
                <div class="content mt-4 flex flex-wrap gap-5 ">
                    @for ($i = 0; $i < 10; $i++)
                        <div
                            ...
                            <div
                                class="py-8 w-full rounded-t-md bg-slate-100 flex flex-row justify-center items-center">
                                <img class="w-40"
                                    src="https://themes.programmingkit.xyz/rafcart/assets/images/laptop-3.png"
                                    alt="">
                            </div>

                            {{-- Block Icon --}}
                            <div
                                class="children-1 py-8  h-[5.35cm] w-full rounded-t-md box flex flex-row justify-center items-center absolute top-0">
                            ...
                            <div class=" p-5 text-left w-full ">
                                ...
                                <div class="flex flex-row justify-start items-center gap-3  mt-1">
                                    <p class="text-danger font-medium">$45.00</p>
                                    <p class="font-medium text-slate-500 text-sm line-through">$55.00</p>
                                </div>
                                {{-- End Block Price --}}
...
<div id="overlay"
    ...
    <div id="pop-detail" class="w-9/12 h-[14cm] bg-white rounded-sm boxShadow  overflow-y-auto">
        ...
        <div class="w-full flex flex-row justify-between px-6 gap-5 ">
            ...
            <div class="w-[47.5%] h-[12cm]   ">
                ...
                <div class="relative w-full h-full overflow-hidden">
                    <div id="slider" class="relative w-full h-full overflow-hidden">
                        <img id="main-image" class="w-full h-full object-cover transition-transform duration-300"
                            src="https://themes.programmingkit.xyz/rafcart/assets/images/slider-1.png"
                            alt="Main Image">
                    </div>

                    <!-- Block Slide children of Image Item -->
                    <div class="absolute inset-x-0 top-1/2 flex justify-between transform -translate-y-1/2 px-2">
                        <!-- Block Prev Button -->
                        <button id="prev-btn"
                ...
                <!-- Thumbnails Image List -->
                <div id="thumbnail-slider" class="bottom-0 w-full flex justify-center space-x-2 py-1">
                    @foreach ($childrenImages as $index => $image)
                        <img class="w-16 h-16 cursor-pointer object-cover" src="{{ $image }}"
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const imageList = Array.from(thumbnails).map(thumbnail => thumbnail.src);
            ...
            {{-- Block right --}}
            <div class="w-[52.5%] flex flex-col justify-start items-start gap-2">
                <h1 class="text-2xl uppercase font-medium ">MEN'S ADIDAS COURTSMASH</h1>
                <div class="flex flex-row justify-start items-center gap-1">
                    {{-- Star 1 --}}
                    <svg class="w-4 h-4 fill-yellow-400 text-transparent" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24" fill="none">
                        <path
                            d="M13.7276 3.44418L15.4874 6.99288C15.7274 7.48687 16.3673 7.9607 16.9073 8.05143L20.0969 8.58575C22.1367 8.92853 22.6167 10.4206 21.1468 11.8925L18.6671 14.3927C18.2471 14.8161 18.0172 15.6327 18.1471 16.2175L18.8571 19.3125C19.417 21.7623 18.1271 22.71 15.9774 21.4296L12.9877 19.6452C12.4478 19.3226 11.5579 19.3226 11.0079 19.6452L8.01827 21.4296C5.8785 22.71 4.57865 21.7522 5.13859 19.3125L5.84851 16.2175C5.97849 15.6327 5.74852 14.8161 5.32856 14.3927L2.84884 11.8925C1.389 10.4206 1.85895 8.92853 3.89872 8.58575L7.08837 8.05143C7.61831 7.9607 8.25824 7.48687 8.49821 6.99288L10.258 3.44418C11.2179 1.51861 12.7777 1.51861 13.7276 3.44418Z"
                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                    ...
                    {{-- Parapgram --}}
                    <p class="text-sm text-gray-500 font-[100] ml-2 ">50 Reviews</p>
                </div>
                ...
                <div class="flex flex-row justify-start items-center gap-3">
                    <p class="line-through font-medium text-gray-500">$500.00</p>
                    <h3 class="text-xl text-danger font-medium">$4500.00</h3>

                    <span class="flex flex-row justify-center items-center bg-danger p-1 text-xs text-white relative">
                        <div
                ...
                <div class=" w-full flex flex-col justify-start items-start">
                    <form action="/add-to-cart" method="POST">
                        ...
                        <!-- Color Selection -->
                        <div class="flex flex-col justify-center items-start gap-2 mb-4">
                            <h1>Color</h1>
                            <div class="flex space-x-2 text-xs">
                                <button type="button"
                        ...
                        <!-- Quantity Selection -->
                        <div class="flex flex-col justify-start items-start gap-2 mb-6">
                            <h1>Quantity</h1>
                    ...
                    <div class="mb-8 flex flex-row justify-start items-center gap-2">
                        <a href="#" class="p-1 rounded-full border active:bg-slate-200 hover:bg-slate-100">
                            <svg class="w-5  fill-sceondary" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {{-- Twitter --}}
                        <a href="#" class="p-1 rounded-full border active:bg-slate-200 hover:bg-slate-100">
                            <svg class="w-5 text-sceondary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="none">
                                <path
...
<style>
    ...
    {{-- <style>
    /* Basic styles for overlay and popDetail */
    #overlay {
        display: none;
        position: fixed;
        top: 0;
