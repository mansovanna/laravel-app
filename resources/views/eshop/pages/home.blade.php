                ...
                <div class="content mt-4 flex flex-wrap gap-5 ">
                    @for ($i = 0; $i < 10; $i++)
                        <div
                            ...
                            <div class="py-8 w-full rounded-t-md bg-slate-100 flex flex-row justify-center items-center">
                                <img class="w-40" src="https://themes.programmingkit.xyz/rafcart/assets/images/laptop-3.png"
                                    alt="">
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-row gap-3">
                                    ...
                                    <button id="button-details"
                                        ...
                                        <svg class="text-white w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            fill="none">
                            ...
                            <div class=" p-5 text-left w-full ">
                                ...
                                <div class="flex flex-row justify-start items-center gap-2">
                                    {{-- Star 1 --}}
                                    <svg class="w-4 text-transparent fill-yellow-400" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 24 24">
                                        <path
...
<div id="overlay"
    ...
    <div id="pop-detail" class="w-9/12 h-[14cm] bg-white rounded-sm boxShadow  overflow-y-auto">
        ...
        <div class="w-full flex flex-row justify-end items-center p-2">
            <button class="p-1 rounded-sm bg-danger"></button>
            <svg class="w-4 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"></svg>
            ...
            <div class="container flex items-center  justify-center">
                <div class="w-11/12  flex flex-col justify-start items-center">
                    ...
                    <div class="py-4 w-full flex flex-row justify-start items-start gap-2  col-start-1 col-end-8">
                        {{-- Icon --}}
                        <svg class="text-danger w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        ...
                        {{-- Icon arrow --}}
                        <svg class="w-4 h-4 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color="#000000"
                            fill="none">
                            <path d="M9.00005 6C9.00005 6 15 10.4189 15 12C15 13.5812 9 18 9 18" stroke="currentColor"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                                ...
                                @foreach ($products as $index => $product)
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <img class="h-[5cm] " src="{{ asset('images/' . $product->image) }}" alt="">
                                                                    </div>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="flex flex-row gap-3">
                                                                            ...
                                                                            <button id="buttonSetDefault-{{ $index }}" type="button"
                                                                ...
                                                                <script>
                                                                    document.addEventListener('DOMContentLoaded', function () {
                                                                        ...
                                                                        document.addEventListener('click', (e) => {
                                                                            if (!button{{ $index }}.contains(e.target) && !popShow{{ $index }}.contains(e
                                                                                .target)) {
                                                                                popup{{ $index }}.classList.remove('flex');
                                                                                popup{{ $index }}.classList.add('hidden');
                                                                            }
                                                                ...
                                                                <div id="popUpDetailt-{{ $index }}"
                                                                    ...
                                                                    <div id="pop-detail-{{ $index }}"
                                                                        ...
                                                                        {{-- Icon Close --}}
                                                                        <div class="w-full flex flex-row justify-end items-center p-2">
                                                                            <button id="closePopUp-{{ $index }}" class="p-1 rounded-sm bg-danger">
                                                                                <svg class="w-4 text-white" xmlns="http://www.w3.org/2000/svg"
                                                                                    viewBox="0 0 24 24" fill="none">
                                                                                    <path
                                                                        ...
                                                                        <div class="w-full flex flex-row justify-between px-6 gap-5 ">
                                                                                ...
                                                                                <div id="thumbnail-slider-{{ $index }}"
                                                                                    ...
                                                                                    @foreach ($childrenImages as $thumbIndex => $image)
                                                                                        <img class="w-16 h-16 cursor-pointer object-cover"
                                                                                            src="{{ $image }}" alt="Thumbnail {{ $thumbIndex + 1 }}"
                                                                            ...
                                                                            <div class="w-[52.5%] flex flex-col justify-start items-start gap-2">
                                                                                <h1 class="text-2xl uppercase font-medium ">{{ $product->name }}
                                                                                </h1>
                                                                                <div class="flex flex-row justify-start items-center gap-1">
                                                                                    ...
                                                                                    {{-- Parapgram --}}
                                                                                    <p class="text-sm text-gray-500 font-[100] ml-2 ">50 Reviews
                                                                                    </p>
                                                                                </div>
                                                                                ...
                                                                                <div class=" w-full flex flex-col justify-start items-start">
                                                                                    ...
                                                                                    <div class="mb-8 flex flex-row justify-start items-center gap-2">
                                                                                        <a href="#"
                                                                                            ...
                                                                                            <svg class="w-5  fill-sceondary" viewBox="0 0 24 24"
