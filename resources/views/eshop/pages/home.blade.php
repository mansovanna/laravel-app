                                ...
                                <div id="pop-detail-{{ $index }}"
                                    ...
                                    <div class="w-full flex flex-row justify-between px-6 gap-5 ">
                                        ...
                                        <div class="w-[52.5%] flex flex-col justify-start items-start gap-2">
                                            <h1 class="text-2xl uppercase font-medium ">{{ $product->name }}</h1>
                                            ...
                                            <div class="flex flex-row justify-start items-center gap-3">
                                                ...
                                                <p class="line-through font-medium text-gray-500">${{ $product->price }}</p>
                                                <h3 class="text-xl text-danger font-medium">${{ $product->discount }}</h3>
                                                <span
                                                ...
                                                @else
                                                <h3 class="text-xl text-danger font-medium">${{ $product->price }}</h3>
                                                @endif
                                            ...
                                            <div class=" w-full flex flex-col justify-start items-start">
                                                ...
                                                <div class="mb-8 flex flex-row justify-start items-center gap-2">
                                                    ...
                                                    <a href="#"
                                                        class="p-1 rounded-full border active:bg-slate-200 hover:bg-slate-100">
                                                        <svg class="w-5 text-sceondary" xmlns="http://www.w3.org/2000/svg"
                                                            viewBox="0 0 24 24" fill="none">
                                                            <path
