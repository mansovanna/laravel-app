            ...
            <div class="w-11/12  flex flex-col gap-4 ">
                ...
                <div class="w-full p-4 border rounded-lg flex flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex flex-col  items-start justify-center">
                        <h2 class=" font-medium text-sceondary text-lg">{{ $item['name'] }}</h2>
                    ...
                    <div class="flex flex-row justify-center items-center ">
                        <button class="p-2 border border-r-0 active:bg-slate-100">
                            <svg class="fill-none w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <input type="number" name="" id="" class="border p-1 w-20" value="{{ $item['quantity'] }}">


                        <button class="p-2 border border-l-0 active:bg-slate-100">
                            <svg class="fill-none w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    ...
                    <div class="flex fex-row justify-end items-center gap-3">
