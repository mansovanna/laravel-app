...
@section('content')
    <div class="w-full h-screen flex flex-row justify-center items-center ">
        <div class="w-4/12 p-4 rounded-sm shadow-md">
            <form action="{{ route('loign') }}" method="POST">

                @csrf
                <h1 class="text-center font-bold text-2xl">Login User</h1>
            ...
            <button class="bg-blue-600 text-white p-2 w-full rounded-md mt-6 hover:bg-blue-500 active:bg-blue-600">Login</button>
